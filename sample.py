...
parser.add_argument('--stroke_width', type=float, default=3.0,
...
def sample_sketches(min_size_ratio = 0.0, max_size_ratio = 0.8, min_num_stroke = 3, max_num_stroke=80, svg_only = True):
